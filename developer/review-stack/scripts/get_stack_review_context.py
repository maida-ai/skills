#!/usr/bin/env python3
"""Fetch PR commits and deduplicated review threads grouped by commit."""
...
def main() -> int:
    ...
    graphql_file = script_dir / "pr-stack-review.graphql"
    jq_file = script_dir / "group-stack-review.jq"
